...
module.exports = function(ref, app, dbconnection) {
	var dbconnection = ref.dbconnection,
		query = '';
	var routingData = [{
            'url': '/',
            'method': 'get',
            'callbackFun': function(req, res){
				res.render(ref.dbconnection.first);
			}
        },
        {
            'url': '/updateProfile',
    ...
    routingData.forEach(function(obj) {
       ref.app[obj.method](obj.url, obj.callbackFun); 
    });
